...
module.exports = function (app, userOptions) {
    ...
    jsonFiles.forEach(function (file) {
        ...
        options.basePathJson = path.join(process.cwd(), options.routesPath);
        options.basePathController = path.join(process.cwd(), options.controllersPath);
        options.basePathPolicy = path.join(process.cwd(), options.policyPath);
